                                     ...
                                     G4TouchableHistory*)
{
  ...
  if (aStep -> IsFirstStepInVolume() && particleDef -> GetParticleName() == "opticalphoton")
  {
		// Total Energy
		G4double TotalEnergy = aStep->GetPreStepPoint()->GetTotalEnergy();

    auto newHit = new TrackerHit();
    newHit->SetEdep(TotalEnergy);
